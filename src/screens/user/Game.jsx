...
// For React Native CLI, you'll need to install vector icons separately
// Run: npm install react-native-vector-icons
// Then link: react-native link react-native-vector-icons
        ...
        <View style={styles.cardHeader}>
          <View style={styles.gameIconContainer}>
            <View style={[
              ...
              {/* Using real icon component instead of image */}
