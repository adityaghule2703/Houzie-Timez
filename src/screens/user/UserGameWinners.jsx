        ...
        {ticketData.map((row, rowIndex) => (
          <View key={`row-${rowIndex}`} style={styles.ticketRow}>
            {row.map((cell, colIndex) => {
              ...
              if (isEmpty) {
                cellBackgroundColor = DARK_TEAL; // Dark teal for empty cells
              } else if (isMarked) {
                cellBackgroundColor = ACCENT_COLOR; // Gold for marked numbers
              } else {
                cellBackgroundColor = SECONDARY_COLOR; // Teal for numbers
              }
                ...
                >
                  {!isEmpty && (
                    <View style={styles.cellContent}>
                      <Text style={[
                        styles.cellNumber,
                        isMarked ? { color: SECONDARY_COLOR } : { color: LIGHT_ACCENT }
                      ]}>
                        {cellNumber}
                      </Text>
                      {isMarked && (
                        <View style={styles.markedIndicator}>
                          <Ionicons name="checkmark-circle" size={8} color={SECONDARY_COLOR} />
                        </View>
                      )}
                    </View>
                  )}
          ...
          >
            <View style={[
              ...
              <Ionicons 
                name="trophy" 
                size={16} 
                color={selectedPattern?.game_pattern_id === pattern.game_pattern_id ? SECONDARY_COLOR : ACCENT_COLOR} 
              />
            </View>
            <Text style={[
      ...
      return (
        <View style={styles.noWinnersContainer}>
          <View style={styles.noWinnersIcon}>
            <Ionicons name="trophy-outline" size={50} color={MUTED_GOLD} />
          </View>
        ...
        renderItem={({ item: winner, index }) => (
          <View key={winner.id} style={styles.winnerCard}>
            ...
            <View style={styles.winnerCardHeader}>
              ...
              <View style={styles.winnerPrize}>
                <View style={styles.prizeAmountContainer}>
                  <FontAwesome name="rupee" size={16} color={SUCCESS_GREEN} />
            ...
            <View style={styles.winnerFooter}>
              ...
              >
                <Ionicons name="eye" size={16} color={SECONDARY_COLOR} />
      ...
      <View style={styles.statsContainer}>
        ...
        >
          <View style={[styles.statIcon, { backgroundColor: 'rgba(76, 175, 80, 0.1)' }]}>
            <FontAwesome name="rupee" size={24} color={SUCCESS_GREEN} />
          </View>
        ...
        >
          <View style={[styles.statIcon, { backgroundColor: 'rgba(100, 181, 246, 0.1)' }]}>
            <Ionicons name="layers" size={24} color="#64B5F6" />
          </View>
              ...
              <>
                ...
                <View style={styles.modalFooter}>
                  <View style={styles.modalWinTime}>
                    <Ionicons name="time" size={14} color={MUTED_GOLD} />
        ...
        <View style={styles.content}>
          ...
          >
            <View style={styles.bannerContent}>
              {/* <View style={styles.bannerTrophy}>
                <Ionicons name="trophy" size={60} color={SECONDARY_COLOR} />
              </View> */}
            ...
            <View style={styles.userStatusCard}>
              <View style={styles.userStatusHeader}>
                <Ionicons 
                  ...
                  size={24} 
                  color={winnersData.current_user.is_winner ? SUCCESS_GREEN : ACCENT_COLOR} 
                />
                <Text style={[
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.goBack()}
          >
            <Ionicons name="arrow-back" size={16} color={SECONDARY_COLOR} />
