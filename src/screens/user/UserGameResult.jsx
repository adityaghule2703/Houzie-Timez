        ...
        {gameStats && (
          <View style={styles.statsGrid}>
            <View style={styles.statRow}>
              <View style={styles.statCardSmall}>
                <View style={styles.statIconContainer}>
                  <Icon name="people" size={16} color={PRIMARY_COLOR} />
                </View>
              ...
              <View style={styles.statCardSmall}>
                <View style={styles.statIconContainer}>
                  <Icon name="ticket" size={16} color={SUCCESS_COLOR} />
                </View>
                <View style={styles.statTextContainer}>
                  <Text style={styles.statValueSmall}>
            ...
            <View style={styles.statRow}>
              <View style={styles.statCardSmall}>
                <View style={styles.statIconContainer}>
                  <Icon name="trophy" size={16} color={WARNING_COLOR} />
                </View>
                <View style={styles.statTextContainer}>
                  <Text style={styles.statValueSmall}>
              ...
              <View style={styles.statCardSmall}>
                <View style={styles.statIconContainer}>
                  <Icon name="cash" size={16} color={PRIMARY_COLOR} />
                </View>
                <View style={styles.statTextContainer}>
                  <Text style={styles.statValueSmall}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.statsGrid}>
            <View style={styles.statRow}>
              <View style={styles.statCardSmall}>
                <View style={styles.statIconContainer}>
                  <Icon name="ticket" size={16} color={PRIMARY_COLOR} />
                </View>
                <View style={styles.statTextContainer}>
                  <Text style={styles.statValueSmall}>
              ...
              <View style={styles.statCardSmall}>
                <View style={styles.statIconContainer}>
                  <Icon name="checkmark-done" size={16} color={SUCCESS_COLOR} />
                </View>
                <View style={styles.statTextContainer}>
                  <Text style={styles.statValueSmall}>
            ...
            <View style={styles.statRow}>
              <View style={styles.statCardSmall}>
                <View style={styles.statIconContainer}>
                  <Icon name="cash" size={16} color={WARNING_COLOR} />
                </View>
                <View style={styles.statTextContainer}>
                  <Text style={styles.statValueSmall}>
              ...
              <View style={styles.statCardSmall}>
                <View style={styles.statIconContainer}>
                  <Icon name="trophy" size={16} color={PRIMARY_COLOR} />
                </View>
                <View style={styles.statTextContainer}>
                  <Text style={styles.statValueSmall}>
    ...
    <View style={styles.tabContent}>
      ...
      <View style={styles.card}>
        ...
        {gameData?.all_game_winners?.top_winners && gameData.all_game_winners.top_winners.length > 0 ? (
          ...
          <View style={styles.emptyState}>
            <Icon name="trophy-outline" size={30} color={GRAY_COLOR} />
      ...
      <View style={styles.card}>
        ...
        {allWinners.length > 0 ? (
          ...
          <View style={styles.emptyState}>
            <Icon name="people-outline" size={30} color={GRAY_COLOR} />
    ...
    <View style={styles.tabContent}>
            ...
            {myWinnings.map((winning, index) => (
              <View key={index} style={styles.winningItem}>
                <View style={styles.winningIcon}>
                  <Icon name="trophy" size={18} color={WARNING_COLOR} />
                </View>
      ...
      <View style={styles.card}>
        ...
        {myTickets.length > 0 ? (
              ...
              <View key={index} style={styles.ticketItem}>
                ...
                <View style={styles.ticketStats}>
                  <View style={styles.ticketStat}>
                    <Icon name="checkmark-circle" size={12} color={SUCCESS_COLOR} />
                    <Text style={styles.ticketStatText}>{ticket.marked_numbers_count} Marked</Text>
                  </View>
                  <View style={styles.ticketStat}>
                    <Icon name="close-circle" size={12} color={DANGER_COLOR} />
          ...
          <View style={styles.emptyState}>
            <Icon name="ticket-outline" size={30} color={GRAY_COLOR} />
    ...
    <View style={styles.tabContent}>
      <View style={styles.card}>
        ...
        {calledNumbers.length > 0 ? (
                    ...
                    >
                      ...
                      {isLatest && (
                        <View style={styles.latestIndicator}>
                          <Icon name="star" size={6} color="#FFF" />
                        </View>
                      )}
                    </View>
                  );
          ...
          <View style={styles.emptyState}>
            <Icon name="numbers-outline" size={30} color={GRAY_COLOR} />
          ...
          <View style={styles.headerTop}>
            ...
            <View style={styles.headerTextContainer}>
              ...
              <View style={styles.gameInfoContainer}>
                <Icon name="game-controller" size={14} color="rgba(255,255,255,0.8)" />
