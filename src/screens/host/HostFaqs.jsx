  ...
  const fetchHelpLinks = async () => {
    try {
      ...
      if (response.data.status && response.data.data) {
        ...
        if (response.data.data.all && Array.isArray(response.data.data.all)) {
          setHelpLinks(response.data.data.all);
        } else if (Array.isArray(response.data.data)) {
          // Fallback for older API structure
          setHelpLinks(response.data.data);
        } else {
          setHelpLinks([]);
        }
      } else {
    ...
    return (
      <View style={styles.helpLinksContainer}>
        <View style={styles.helpLinksHeader}>
          ...
          <Text style={styles.helpLinksTitle}>Helpful Videos & Guides</Text>
        </View>
        <Text style={styles.helpLinksSubtitle}>
          Watch tutorials and read guides to learn how to host Tambola games
        </Text>
