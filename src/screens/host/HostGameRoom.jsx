...
// // // Custom Snackbar Component - Non-blocking (FROM WORKING VERSION)
// // const CustomSnackbar = ({ visible, message, onDismiss, action }) => {
// //   const [animation] = useState(new Animated.Value(0));
...
// // // Interval Selector Component - Boxes for 8-15 seconds in 4x2 grid (YOUR ORIGINAL DESIGN)
...
// //   // Live Chat States (FROM WORKING VERSION)
// //   const [participantCount, setParticipantCount] = useState(0);
// //   const [isChatJoined, setIsChatJoined] = useState(false);
  
// //   // Pending Claims States (FROM WORKING VERSION)
// //   const [pendingClaimsCount, setPendingClaimsCount] = useState(0);
// //   const [claims, setClaims] = useState([]);
  
// //   // Snackbar States (FROM WORKING VERSION)
// //   const [snackbarVisible, setSnackbarVisible] = useState(false);
// //   const [snackbarMessage, setSnackbarMessage] = useState('');
  
// //   // App State for foreground/background detection (FROM WORKING VERSION)
// //   const [appState, setAppState] = useState(AppState.currentState);
  
// //   // Pusher Refs (FROM WORKING VERSION)
// //   const pusherRef = useRef(null);
// //   const gameChannelRef = useRef(null);
// //   const adminChannelRef = useRef(null);
// //   const isMountedRef = useRef(true);
  
// //   // Reconnection Refs (FROM WORKING VERSION)
// //   const reconnectAttemptsRef = useRef(0);
// //   const reconnectTimeoutRef = useRef(null);
// //   const maxReconnectAttempts = 10;
  
// //   // Queue for missed events during disconnection (FROM WORKING VERSION)
// //   const missedEventsQueueRef = useRef([]);
// //   const processingQueueRef = useRef(false);
// //   const isPusherConnectedRef = useRef(false);

// //   // Refs for latest values (FROM WORKING VERSION)
// //   const calledNumbersRef = useRef([]);
// //   const numberCallingStatusRef = useRef(null);
// //   const pendingClaimsRef = useRef(0);
// //   const fetchGameStatusTimeoutRef = useRef(null);
...
// //   // Auto-start retry ref (FROM WORKING VERSION)
// //   const autoStartRetryTimeoutRef = useRef(null);

// //   const pulseAnim = useRef(new Animated.Value(1)).current;
// //   const manualButtonAnim = useRef(new Animated.Value(1)).current;

// //   // Handle App State changes (foreground/background) (FROM WORKING VERSION)
// //   useEffect(() => {
// //     const subscription = AppState.addEventListener('change', nextAppState => {
// //       if (appState.match(/inactive|background/) && nextAppState === 'active') {
// //         console.log(`[Game ${gameId}] App came to foreground - refreshing data`);
...
// //   // Set hasAppliedInterval when initialization is complete (YOUR ORIGINAL)
// //   useEffect(() => {
// //     if (numberCallingStatus?.auto_mode && intervalSeconds) {
// //       setHasAppliedInterval(true);
// //       setIsInitializationComplete(true);
...
// //   // Handle app coming to foreground (FROM WORKING VERSION)
// //   const handleAppForeground = async () => {
// //     if (!isMountedRef.current) return;
...
// //   // Update refs when state changes (FROM WORKING VERSION)
// //   useEffect(() => {
// //     calledNumbersRef.current = calledNumbers;
// //   }, [calledNumbers]);
...
// //   // Set mounted ref (FROM WORKING VERSION)
// //   useEffect(() => {
// //     isMountedRef.current = true;
...
// //   // Initialize Pusher with better connection handling (FROM WORKING VERSION)
// //   const initializePusher = async () => {
// //     try {
// //       console.log(`[Game ${gameId}] Initializing Pusher...`);
...
// //   // Process missed events queue (FROM WORKING VERSION)
// //   const processMissedEventsQueue = async () => {
// //     if (processingQueueRef.current || missedEventsQueueRef.current.length === 0) {
// //       return;
// //     }
...
// //   // Handle game channel events with queueing (FROM WORKING VERSION)
// //   const handleGameEvent = (event) => {
// //     console.log(`[Game ${gameId}] Game channel event: ${event.eventName}`);
...
// //   // Handle admin channel events with queueing (FROM WORKING VERSION)
// //   const handleAdminEvent = (event) => {
// //     console.log(`[Game ${gameId}] Admin channel event: ${event.eventName}`);
...
// //   // Handle number called event - improved (FROM WORKING VERSION)
// //   const handleNumberCalled = (data) => {
// //     if (!isMountedRef.current) return;
...
// //   // Handle status updated event (FROM WORKING VERSION)
// //   const handleStatusUpdated = (data) => {
// //     if (!isMountedRef.current) return;
...
// //   // Handle new claim submitted event (FROM WORKING VERSION)
// //   const handleNewClaimSubmitted = (data) => {
// //     if (!isMountedRef.current) return;
...
// //   // Handle claim processed event (FROM WORKING VERSION)
// //   const handleClaimProcessed = (data) => {
// //     if (!isMountedRef.current) return;
...
// //   // Handle game completed event (FROM WORKING VERSION)
// //   const handleGameCompleted = (data) => {
// //     if (!isMountedRef.current) return;
...
// //   // Schedule reconnection with exponential backoff (FROM WORKING VERSION)
// //   const scheduleReconnection = () => {
// //     if (!isMountedRef.current) return;
...
// //   // Reconnect function (FROM WORKING VERSION)
// //   const reconnectPusher = async () => {
// //     try {
// //       console.log(`[Game ${gameId}] Attempting to reconnect Pusher...`);
...
// //   // Cleanup Pusher connections (FROM WORKING VERSION)
// //   const cleanupPusher = async () => {
// //     console.log(`[Game ${gameId}] Cleaning up Pusher...`);
...
// //   // Custom Snackbar functions (FROM WORKING VERSION)
// //   const showSnackbar = (message) => {
// //     if (!isMountedRef.current) return;
...
// //   // Improved fetchGameStatus (FROM WORKING VERSION)
// //   const fetchGameStatus = async (showLoading = true) => {
// //     if (!isMountedRef.current) return;
...
// //   // UseFocusEffect to refresh when screen comes into focus (FROM WORKING VERSION)
// //   useFocusEffect(
// //     useCallback(() => {
// //       console.log(`[Game ${gameId}] 📱 Screen focused - refreshing data`);
...
// //           {/* Connection status indicator (FROM WORKING VERSION) */}
// //           <View style={[styles.pendingClaimsWarning, { borderLeftColor: isPusherConnectedRef.current ? '#4CAF50' : '#FF5722' }]}>
// //             <Ionicons 
// //               name={isPusherConnectedRef.current ? "wifi" : "wifi-outline"} 
// //               size={18} 
...
// // // ALL STYLES ARE YOUR ORIGINAL DESIGN (with interval boxes, etc.)
// // const styles = StyleSheet.create({
// //   safeArea: {
// //     flex: 1,
// //     backgroundColor: "#F8FAFC",
...
// //   // Interval Selector Styles - 4x2 Grid (YOUR ORIGINAL DESIGN)
...
//   // NEW: Render All Numbers in 10x9 grid (1-90) - exactly like UserGameRoom
...
//   // NEW: Render Last Called Numbers in circular format - exactly like UserGameRoom
//   const renderLastCalledSection = () => {
...
//           {/* Circular numbers - show most recent on left side */}
...
//         {/* NEW: All Numbers Section (compact 10x9 grid) */}
//         {renderAllNumbersSection()}

//         {/* NEW: Last Called Numbers Section (circular format) */}
//         {renderLastCalledSection()}
...
// // UPDATED STYLES - Added new styles for circular numbers and compact grid from UserGameRoom
// const styles = StyleSheet.create({
//   safeArea: {
//     flex: 1,
//     backgroundColor: "#F8FAFC",
...
//   // NEW: Card styles from UserGameRoom
//   card: {
//     backgroundColor: "#FFF",
//     borderRadius: 14,
//     padding: 14,
...
//   // NEW: Last Called Section styles (circular)
//   lastCalledSection: {
//     marginBottom: 0,
//   },
//   lastCalledHeader: {
...
//   // NEW: All Numbers Section styles (compact 10x9 grid)
//   allNumbersCard: {
//     backgroundColor: "#FFF",
//     borderRadius: 14,
//     padding: 14,
...
//   // Original styles kept for other sections
//   actionsSection: {
//     flexDirection: "row",
//     flexWrap: "wrap",
//     gap: 12,
