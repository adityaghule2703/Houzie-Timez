...
//         "https://tambolatime.co.in/public/api/host/dashboard-summary",
//         {
//           headers: {
...
//       const response = await axios.get(
//         "https://tambolatime.co.in/public/api/host/notifications",
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
//             Accept: "application/json",
...
//               <Icon name="today-outline" size={20} color="#FF7675" />
//             </View>
...
//           <View style={styles.gameStatHeader}>
//             <View style={[styles.gameStatIcon, { backgroundColor: '#FFEDED' }]}>
//               <Icon name="calendar-outline" size={20} color="#FF7675" />
//             </View>
//             <View style={styles.gameStatTextContainer}>
...
//             <Icon name="alert-circle-outline" size={24} color="#FF7675" />
//           </View>
...
//           <Icon name="arrow-forward" size={16} color="#FF7675" />
//         </TouchableOpacity>
//       </View>
...
//           <Icon name="game-controller-outline" size={60} color="#CCC" />
...
//             <Icon name="add-circle-outline" size={24} color="#FF7675" />
//           </View>
...
//         >
//           <View style={[styles.actionIcon, { backgroundColor: '#FFEDED' }]}>
//             <Icon name="ticket-outline" size={24} color="#FF7675" />
//           </View>
...
//         >
//           <View style={[styles.actionIcon, { backgroundColor: '#FFEDED' }]}>
//             <Icon name="bar-chart-outline" size={24} color="#FF7675" />
//           </View>
...
//                       <Icon name="notifications" size={20} color="#FF7675" />
//                     </View>
...
const CustomLoader = () => {
  ...
  const messages = [
    "Loading dashboard...",
    "Fetching game stats 🎮",
    "Getting ticket data 🎟️",
    "Almost ready...",
    "Preparing your host panel 🔥",
    "Loading analytics..."
  ];
  ...
  return (
    <LinearGradient colors={['#FF7675', '#FFB6B9']} style={styles.loaderContainer}>
      ...
      >
        <Text style={styles.ticketText}>🎮 Loading Dashboard...</Text>
      </Animated.View>
    </LinearGradient>
  );
};
