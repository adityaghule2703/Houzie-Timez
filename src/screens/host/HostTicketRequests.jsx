...
const HostTicketRequests = ({ navigation, route }) => {
  ...
  const fetchTicketRequests = async () => {
    try {
      ...
      let url = "https://tambolatime.co.in/public/api/host/ticket-requests";
      if (gameId) {
        url += `?game_id=${gameId}`;
      }
  ...
  const markAsPaid = async (requestId) => {
    try {
      ...
      const response = await axios.put(
        `https://tambolatime.co.in/public/api/host/ticket-requests/${requestId}/mark-paid`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleApproveRequest = async (requestId) => {
    try {
      ...
      const response = await axios.put(
        `https://tambolatime.co.in/public/api/host/ticket-requests/${requestId}/approve`,
        body,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleRejectRequest = async (requestId) => {
    try {
      ...
      const response = await axios.put(
        `https://tambolatime.co.in/public/api/host/ticket-requests/${requestId}/reject`,
        body,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleBulkApprove = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://tambolatime.co.in/public/api/host/ticket-requests/bulk-process",
        body,
        {
          headers: {
            Authorization: `Bearer ${token}`,
